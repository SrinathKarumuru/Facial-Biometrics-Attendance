...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'manav.shah2020@vitbhopal.ac.in' ")
...
window.title("Attendance System Project | VIT Bhopal")
window.configure(background='#330000')

frame1 = tk.Frame(window, bg="#ffff80")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#ffff80")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Face Recognition Based Attendance Monitoring System | VIT Bhopal" ,fg="white",bg="#330000" ,width=63 ,height=1,font=('times', 27, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+" -", fg="#ff61e5",bg="#330000" ,width=55 ,height=1,font=('times', 17, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="#ff61e5",bg="#330000" ,width=55 ,height=1,font=('times', 17, ' bold '))
...
lbl = tk.Label(frame2, text="Enter ID",width=20  ,height=1  ,fg="black"  ,bg="#ffff80" ,font=('comic', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('comic', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="black"  ,bg="#ffff80" ,font=('comic', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2,width=32 ,fg="black",font=('comic', 15, ' bold ')  )
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile" ,bg="#ffff80" ,fg="black"  ,width=39 ,height=1, activebackground = "#3ffc00" ,font=('comic', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="#c79cff" ,fg="black"  ,width=39,height=1, activebackground = "#3ffc00" ,font=('comic', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Attendance",width=20  ,fg="black"  ,bg="#ffff80"  ,height=1 ,font=('comic', 17, ' bold '))
